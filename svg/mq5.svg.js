export default function MQ5SVG(s, cfg, modelName) {
  return `
<svg viewBox="0 0 450 770">
  ...
  <!-- Blue PCB background based on the image -->
  <rect x="0" y="0" width="450" height="770" rx="40" fill="#1b2bb4" />
  
  <!-- PCB Traces -->
  <path d="M 45 450 L 45 710 L 95 710" fill="none" stroke="#162391" stroke-width="6" stroke-linecap="round" />
  <path d="M 225 555 L 225 620" fill="none" stroke="#162391" stroke-width="6" stroke-linecap="round" />
  <circle cx="225" cy="627" r="9" fill="none" stroke="#162391" stroke-width="6" />
  <path d="M 405 450 L 405 710 L 355 710" fill="none" stroke="#162391" stroke-width="6" stroke-linecap="round" />
  ...
  <text x="225" y="60" fill="#ffffff" font-family="'Times New Roman', Times, serif" font-size="52" font-weight="bold" text-anchor="middle" letter-spacing="2">MQ-5</text>
